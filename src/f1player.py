...
def Install_AceStream(): 
    webbrowser.open("https://download.acestream.media/products/acestream-full/win/latest")
...
def Play_SkySportsMainEvent():
    webbrowser.open("acestream://eab7aeef0218ce8b0752e596e4792b69eda4df5e")
...
def Play_SkySportsF1():
    ...
    idlist = templist       
    webbrowser.open("acestream://" + idlist[0])
...
def Play_SkySportsF1_ALT2():
    ...
    webbrowser.open("acestream://" + idlist[1])

def Play_ESPNHD():
    webbrowser.open("acestream://4b4907de51ec11087d4bed5876f2a0c68264f442")

def Play_ESPN2():
    webbrowser.open("acestream://664eb5fe460b96941aed633959a845b185cd8394")
...
def Play_F1TVHD():
    ...
    for s in streamids:
        idlist.append(s.get_attribute("value"))
    webbrowser.open("acestream://" + idlist[2])

def Play_ElevenSports1():
    webbrowser.open("acestream://14407b00d454cb7dc0d70aa26e8bbc554f457f00")
...
def runTimer():
    ...
    while(clockTime > -1):
        ...
        d = round(d)
        hms_time= time.strftime("%H:%M:%S", time.gmtime(hms_time))
